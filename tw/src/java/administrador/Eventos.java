...
public class Eventos extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //String palabra=request.getParameter("nombre");
        //String tipo=(String) session.getAttribute("tipo");
        String xml=request.getRealPath("WEB-INF\\practica2.xml");
        int aux=tamano(xml);
        String[] usuarios=new String[aux];
        usuarios=nombre(xml);
        String[] fecha=new String[aux];
        fecha=fecha(xml);
        String[] lugar=new String[aux];
        lugar=Lugar(xml);
        String[] id=new String[aux];
        id=id(xml);
        String[] cupo=new String[aux];
        cupo=Cupo(xml);
...
"        });");
            ...
            for(int i=0;i<aux;i++){
                ...
                out.println("<h5 class='blanco'>"+fecha[i]+"</h5>");
                out.println("<hr>");
            ...
            for(int i=0;i<aux;i++){
                ...
                out.println("<h5 class='blanco'>"+lugar[i]+"</h5>");
                out.println("<hr>");
            ...
            for(int i=0;i<aux;i++){
                ...
                out.println("<h5 class='blanco'>"+cupo[i]+"</h5>");
                out.println("<hr>");
            ...
            for(int i=0;i<aux;i++){
                ...
                out.println("<button class='btn-info'><a class='blanco' href='InfoEventos?id="+id[i]+"'>Ver info</a></button>");
                out.println("<hr>");
            ...
            "  <div class=\"col-sm-1\"></div>\n" +
            "  <div class=\"col-sm-4\"><button class='btn-info'><a class='blanco' href='cerrar'>Cerrar Sesion</a></button></div>\n" +
...
public int tamano(String direc)
    ...
    public String[] fecha(String direc)
    {
        int aux=tamano(direc);
        int aux2=0;
        String[] nombU=new String[aux];
        try{
            ...
            for(int i=0;i<hijos.size();i++)
            {
                Element hijo=(Element)hijos.get(i);
                    ...
                    nombU[aux2]=hijo.getAttributeValue("Fecha");
                    aux2++;
    ...
    public String[] Lugar(String direc)
    {
        int aux=tamano(direc);
        int aux2=0;
        String[] nombU=new String[aux];
        try{
            ...
            for(int i=0;i<hijos.size();i++)
            {
                Element hijo=(Element)hijos.get(i);
                    ...
                    nombU[aux2]=hijo.getAttributeValue("Lugar");
                    aux2++;
    ...
    public String[] Cupo(String direc)
    {
        int aux=tamano(direc);
        int aux2=0;
        String[] nombU=new String[aux];
        try{
            ...
            for(int i=0;i<hijos.size();i++)
            {
                Element hijo=(Element)hijos.get(i);
                    ...
                    nombU[aux2]=hijo.getAttributeValue("Cupo");
                    aux2++;
