...
public class CrearGrupo extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int rnd=aleatorio.nextInt(999999999)+100000000;
...
"        });");
            ...
            "<h2 class='blanco'>Registrar Evento</h2>\n"+
            "<p class=\"blanco\">Ingrese los datos que se le piden en el formato indicado</p>\n" +
            "");
            out.println("<div class=\"row form-group\">\n" +
            "  <div class=\"col-sm-1\"><input type=\"text\" class=\"form-control\" name=\"idgestor\" value="+id+" style='visibility:hidden'></div>\n" +
            "  <div class=\"col-sm-8\"><p class=\"blanco\"></p>  <input type=\"text\" class=\"form-control\" name=\"id\" value="+rnd+" style='visibility:hidden'></div>\n" +
            "  <div class=\"col-sm-1\"></div>\n" +
            "</div>");
            out.println("<div class=\"row form-group\">\n" +
            "  <div class=\"col-sm-1\"></div>\n" +
            "  <div class=\"col-sm-8\"><p class=\"blanco\">Nombre del evento con el que se identificara el evento: </p>  <input type=\"text\" class=\"form-control\" name=\"nombre\" required></div>\n" +
            "  <div class=\"col-sm-1\"></div>\n" +
            "</div>");
            out.println("<div class=\"row form-group\">\n" +
                    "  <div class=\"col-sm-1\"></div>\n" +
                    "  <div class=\"col-sm-8\">\n" +
            "<p class=\"blanco\">Fecha: </p><input class='form-control' placeholder='DDMMAAAA' type=\"text\" name=\"fecha\" onkeypress=\"return letraNumVal(event)\" required>\n"+
            "</div>\n" +
                    "  <div class=\"col-sm-1\"></div>\n" +
                    /*"<table class=\"table\">\n" +
            "   <thead>\n" +
            ...
            out.println("<div class=\"row form-group\">\n" +
            "  <div class=\"col-sm-1\"></div>\n" +
            "  <div class=\"col-sm-8\"><p class=\"blanco\">Hora: </p>  <input type=\"text\" class=\"form-control\" name=\"hora\" required></div>\n" +
            "  <div class=\"col-sm-1\"></div>\n" +
            "</div>");
            out.println("<div class=\"row form-group\">\n" +
            "  <div class=\"col-sm-1\"></div>\n" +
            "  <div class=\"col-sm-8\"><p class=\"blanco\">Lugar: </p>  <input type=\"text\" class=\"form-control\" name=\"lugar\" required></div>\n" +
            "  <div class=\"col-sm-1\"></div>\n" +
            "</div>");
            out.println("<div class=\"row form-group\">\n" +
            "  <div class=\"col-sm-1\"></div>\n" +
            "  <div class=\"col-sm-8\"><p class=\"blanco\">Cupo: </p>  <input type=\"text\" class=\"form-control\" name=\"cupo\" required></div>\n" +
            "  <div class=\"col-sm-1\"></div>\n" +
            "</div>");
            out.println("<div class=\"row form-group\">\n" +
            "  <div class=\"col-sm-1\"></div>\n" +
            "  <div class=\"col-sm-8\"><p class=\"blanco\">Telefono: </p>  <input type=\"text\" class=\"form-control\" name=\"tel\" required></div>\n" +
            "  <div class=\"col-sm-1\"></div>\n" +
            "</div>");
            out.println("<div class=\"row form-group\">\n" +
            "  <div class=\"col-sm-1\"></div>\n" +
            "  <div class=\"col-sm-8\"><p class=\"blanco\">Correo Electronico: </p>  <input type=\"text\" class=\"form-control\" name=\"correo\" required></div>\n" +
            "  <div class=\"col-sm-1\"></div>\n" +
            "</div>");
            out.println("<div class=\"row form-group\">\n" +
            "  <div class=\"col-sm-1\"></div>\n" +
            "  <div class=\"col-sm-8\"><p class=\"blanco\">Tipo de Evento: </p> <select class=\"form-control\" name=\"opc\" required>\n" +
            ...
            "  <div class=\"col-sm-4\"><input type=\"button\" class=\"btn-info\" value=\"Mis Eventos Creados\" onclick=\"document.location='EventosCreados'\"></div>\n" +
            //"  <div class=\"col-sm-1\"><input type=\"button\" class=\"btn-info\" value=\"Ver Grupos\" onclick=\"document.location='VerGrupos'\"></div>\n" +
            "</div>");
            out.println("<div class=\"row\">\n" +
            "  <div class=\"col-sm-4\"></div>\n" +
            "  <div class=\"col-sm-4\"></div>\n" +
            "  <div class=\"col-sm-4\"><input type=\"button\" class=\"btn-info\" value=\"Cerrar Sesion\" onclick=\"document.location='cerrar'\"></div>\n" +
            //"  <div class=\"col-sm-1\"><input type=\"button\" class=\"btn-info\" value=\"Ver Grupos\" onclick=\"document.location='VerGrupos'\"></div>\n" +
            "</div>");
            out.println("</form>");
            out.println("</body>");
