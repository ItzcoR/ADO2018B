...
public class CrearDiagrama extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<input value='Salvar' type='button' onClick='salvar();regresar();alert(\"Su solicitud ha sido guardada y enviada\")'/>|");
            //out.println("<button class='btn-info'><a href='index.html'>Regresar</a></button>");
            out.println("<br>");
            out.println("Instrucciones:Asegurate de tener tu INE guardada en el formato JPG, despues "
                    + "selecciona la imagen de tu INE con el boton Seleccionar archivo "
                    + "y por ultimo agranda la imagen al tamaño del recuadro en donde aparece."
                    + " si llegas a equivocarte refresca la pagina y se reiniciara el proceso.");
            out.println("<br>");
            out.println("Cuando hayas acabado da click en el boton Salvar y habras mandado tu solicitud para convertirte en gestor");
            ...
            */
            ...
            out.println("<h3>Registrar INE</h3>");
            out.println("<div >");
            ...
            out.println("var pass;");
            out.println("window.onload=function() {nombre = prompt ('Ingrese su nombre'); pass=prompt('Ingrese su password');}");//ventana que abrimos para pedir el nombre del diagrama
            //out.println("window.onload=function() {pass = prompt ('Ingrese su password');}");//ventana que abrimos para pedir el nombre del diagrama
            ...
            out.println("}");
            //manda el string canvas a un servidor para guardarlo en el xml
            ...
            out.println("$.ajax({type:'post',url:'SalvarDiagrama',data:{'canv':canvasstring,'nombre':nombre,'pass':pass}});}");
