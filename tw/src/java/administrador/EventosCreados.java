...
public class EventosCreados extends HttpServlet {
...
"        });");
            ...
            "       <td>");
            for(int i=0;i<aux;i++){
                if(usuarios[i].equals(id)){
                out.println("<h5 id='txtUsuario' class='blanco'>"+nombreE[i]+"</h5>");
                out.println("<hr>");
                }
            }
            out.println("</td>\n" +
...
public int tamano(String direc)
        ...
        try{
            ...
            for(int i=0;i<hijos.size();i++)
            {
                Element hijo=(Element)hijos.get(i);
                    ...
                    nombU[aux2]=hijo.getAttributeValue("Creador");
                    aux2++;
    ...
    public String[] nombreE(String direc)
    {
        int aux=tamano(direc);
        int aux2=0;
        String[] nombU=new String[aux];
